...
public class ServiceExceptionRecord extends UpdatableRecordImpl<ServiceExceptionRecord> implements Record4<String, Date, UByte, String> {

    private static final long serialVersionUID = -584332237;
     ...
     */
    @Override
    public Row4<String, Date, UByte, String> fieldsRow() {
     ...
     */
    @Override
    public Row4<String, Date, UByte, String> valuesRow() {
     ...
     */
    @Override
    public ServiceExceptionRecord value2(Date value) {
        setDate(value);
        return this;
    }
     ...
     */
    @Override
    public ServiceExceptionRecord values(String value1, Date value2, UByte value3, String value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public ServiceExceptionRecord(String serviceId, Date date, UByte exceptionType, String feedVersion) {
        super(ServiceException.SERVICE_EXCEPTION);
