...
public class Status extends TableImpl<StatusRecord> {
    ...
    private static final long serialVersionUID = -88602017;
    ...
    public List<ForeignKey<StatusRecord, ?>> getReferences() {
        return Arrays.<ForeignKey<StatusRecord, ?>>asList(Keys.STATUS_IBFK_3, Keys.STATUS_IBFK_1);
    }

    public Job job() {
        return new Job(this, Keys.STATUS_IBFK_3);
    }
