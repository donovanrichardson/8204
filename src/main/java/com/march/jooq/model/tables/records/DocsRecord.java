...
public class DocsRecord extends UpdatableRecordImpl<DocsRecord> implements Record4<Integer, String, Integer, Long> {

    private static final long serialVersionUID = -1724219715;
    ...
    /**
     * Setter for <code>lexicon.docs.revision</code>.
     */
    ...
    /**
     * Getter for <code>lexicon.docs.revision</code>.
     */
     ...
     */
    @Override
    public Row4<Integer, String, Integer, Long> fieldsRow() {
     ...
     */
    @Override
    public Row4<Integer, String, Integer, Long> valuesRow() {
     ...
     */
    @Override
    public DocsRecord value4(Long value) {
        setRevision(value);
        return this;
    }
     ...
     */
    @Override
    public DocsRecord values(Integer value1, String value2, Integer value3, Long value4) {
        value1(value1);
        value2(value2);
        value3(value3);
        value4(value4);
     ...
     */
    public DocsRecord(Integer docId, String docName, Integer sightings, Long revision) {
        super(Docs.DOCS);
